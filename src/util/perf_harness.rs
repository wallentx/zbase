...
const ENV_BENCH_AUTOSTART: &str = "ZBASE_BENCH_AUTOSTART";
const ENV_BENCH_DURATION_SECS: &str = "ZBASE_BENCH_DURATION_SECS";
const ENV_BENCH_LABEL: &str = "ZBASE_BENCH_LABEL";
const ENV_BENCH_SCENARIO: &str = "ZBASE_BENCH_SCENARIO";
const ENV_BENCH_OUTPUT: &str = "ZBASE_BENCH_OUTPUT";
